...
public class BookingService {
    ...
    // everywhere through the correct custom exceptions
    ...
    public List<ShowSeat> reserveShowSeats(List<Long> showSeatIds) {
        ...
        // First fetch all the showseats from the ids
    ...
    private static Booking createBooking(List<ShowSeat> reservedShowSeats) {
        ...
        // you need to iterate through all the showseats and find the corresponding price for all of them and sum them up.
